"""Pillar 0.2 KITTI three-class deadline experiment (fresh 60-epoch run)."""

_base_ = ["./_base_/kitti_multiclass_common.py"]
...
work_dir = "research/experiments/pillar02_multiclass"
